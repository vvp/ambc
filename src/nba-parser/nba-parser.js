...
var grammar = {
    ...
    {"name": "READS", "symbols": ["READS$string$1", "_", {"literal":"("}, "NAME", "_", {"literal":","}, "_", "NAMES", {"literal":")"}], "postprocess": ([,,,target,,,,names]) => new ast.cap('read', target, names)},
    ...
    {"name": "WRITES", "symbols": ["WRITES$string$2", "_", {"literal":"("}, "NAMES", {"literal":")"}], "postprocess": ([,,,names]) => new ast.cocap('write_', names)},
    ...
    {"name": "INS", "symbols": ["INS$string$2", "_", {"literal":"("}, "NAME", "_", {"literal":","}, "_", "NAME", {"literal":")"}], "postprocess": ([,,,name,,,,pw]) => new ast.cocap('in_', [name, pw])},
    ...
    {"name": "OUTS", "symbols": ["OUTS$string$2", "_", {"literal":"("}, "NAME", "_", {"literal":","}, "_", "NAME", {"literal":")"}], "postprocess": ([,,,name,,,,pw]) => new ast.cocap('out_', [name, pw])},
    ...
    {"name": "SEQUENTIAL", "symbols": [{"literal":"("}, "_", "PARALLEL", "_", {"literal":")"}], "postprocess": ([,,first]) => new ast.context([], first)},
    {"name": "SEQUENTIAL", "symbols": ["AMBIENT"], "postprocess": id},
    {"name": "PARALLEL", "symbols": ["PARALLEL", "_", {"literal":"|"}, "_", "SEQUENTIAL"], "postprocess": ([left,,,,right]) => new ast.context(left, right)},
